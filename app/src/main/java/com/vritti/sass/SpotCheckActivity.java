...
import com.vritti.sass.fragment.SpotCheckActivePermitFragment;
import com.vritti.sass.fragment.SpotCheckCancelledPermitFragment;
import com.vritti.sass.fragment.SpotCheckCompletedFragment;
import com.vritti.sass.fragment.SpotCheckPendingFragment;
...
public class SpotCheckActivity extends AppCompatActivity {
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFrag(new SpotCheckActivePermitFragment(), "Active");
        adapter.addFrag(new SpotCheckCancelledPermitFragment(), "Cancelled");
        adapter.addFrag(new SpotCheckCompletedFragment(), "Completed");
        adapter.addFrag(new SpotCheckPendingFragment(), "Pending");
