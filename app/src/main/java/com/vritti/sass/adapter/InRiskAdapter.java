 ...
 */
public class InRiskAdapter extends BaseAdapter {
    ...
    public InRiskAdapter(Context context1, ArrayList<IndicateRisk> indicateRiskArrayList, String Mode, String PermitStatus) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            holder.txt_others = (TextView) convertView.findViewById(R.id.txt_others);
