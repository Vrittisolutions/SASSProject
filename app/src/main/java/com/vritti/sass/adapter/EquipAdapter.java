...
public class EquipAdapter extends BaseAdapter {
    ...
    public EquipAdapter(Context context1, ArrayList<EquipmentUse> equipmentUseArrayList) {
    ...
    public EquipAdapter(Context context1, ArrayList<EquipmentUse> indicateRiskArrayList, String Mode, String PermitStatus) {
        this.equipmentUseArrayList = indicateRiskArrayList;
        mInflater = LayoutInflater.from(context1);
        context = context1;
        this.mode = Mode;
