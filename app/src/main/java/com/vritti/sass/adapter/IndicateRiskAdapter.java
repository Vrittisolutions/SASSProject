 ...
 */
public class IndicateRiskAdapter extends BaseAdapter {
    ...
    public IndicateRiskAdapter(Context context1, ArrayList<IndicateRisk> indicateRiskArrayList, String Mode, String PermitStatus) {
