 ...
 */
public class PrevenionWAdapter extends BaseAdapter {
    ...
    public PrevenionWAdapter(Context context1, ArrayList<Prevention> preventionArrayList, String Mode) {
    ...
    public PrevenionWAdapter(Context context1, ArrayList<Prevention> indicateRiskArrayList, String Mode, String PermitStatus) {
        this.preventionArrayList = indicateRiskArrayList;
        mInflater = LayoutInflater.from(context1);
        context = context1;
        this.mode = Mode;
