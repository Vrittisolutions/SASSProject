 ...
 */
public class LocationOperationAdapter extends BaseAdapter {
    ArrayList<Location> locationArrayList;
    LayoutInflater mInflater;
    Context context;

    public LocationOperationAdapter(Context context1, ArrayList<Location> locationArrayList) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        holder.txt.setText(locationArrayList.get(position).getLocationDesc());
