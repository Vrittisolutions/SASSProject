...
public class IndicateRiskAdapterNew  extends BaseAdapter {
    ...
    public IndicateRiskAdapterNew(Context context1, ArrayList<IndicateRisk> indicateRiskArrayList, String Mode, String PermitStatus) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        //holder.checkbox_user.setChecked(indicateRiskArrayList.get(position).isChecked());
        ...
        if (indicateRiskArrayList.get(position).getSelectionText().equalsIgnoreCase("Other(s) –Specify") ||
                ...
                || indicateRiskArrayList.get(position).getSelectionText().equalsIgnoreCase("Other")) {
        ...
        if (permitStatus != null && (permitStatus.equalsIgnoreCase("A")
            ...
            holder.checkbox_user.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (text.equalsIgnoreCase("Other(s) – Specify") || text.contains("Other")) {
