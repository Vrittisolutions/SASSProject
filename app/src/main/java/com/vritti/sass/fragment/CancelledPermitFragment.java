...
public class CancelledPermitFragment extends Fragment {
    ...
    public CancelledPermitFragment() {
        ...
        protected void onPostExecute(String integer) {
            ...
            if (response.contains("[]")) {
                ...
                for (int i = 0; i < jResults.length(); i++) {
                    ...
                    if (WorkAuthorizationstatus.equals("R")) {
        ...
        protected void onPostExecute(String integer) {
            ...
            if (response.contains("[]")) {
                ...
                for (int i = 0; i < jResults.length(); i++) {
                    ...
                    if (HotWorkPermitStatus.equals("R")) {
