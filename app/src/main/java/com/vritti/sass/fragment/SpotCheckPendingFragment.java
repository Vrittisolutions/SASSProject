...
public class SpotCheckPendingFragment extends Fragment {
    ...
    public SpotCheckPendingFragment() {
        ...
        protected void onPostExecute(String integer) {
            ...
            if (response.contains("[]")) {
                ...
                for (int i = 0; i < jResults.length(); i++) {
                    ...
                    if (WorkAuthorizationstatus.equals("P")) {
        ...
        protected void onPostExecute(String integer) {
            ...
            if (response.contains("[]")) {
                ...
                for (int i = 0; i < jResults.length(); i++) {
                    ...
                    if (HotWorkPermitStatus.equals("P")) {
